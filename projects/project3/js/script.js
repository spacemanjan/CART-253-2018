...
// Ship(x,y,angle,acceleration,maxSpeed,turningSpeed,shipImage,bulletImage,shootplayer,shootstyle)
	...
	for ( var i = 0; i < 5; i++ ) {
		glitchesLV1.push( new Glitch( random( 100, windowWidth/2 - 100 ), random( 100, windowHeight /2 - 100 ), 0, 0, 10, 0 ) );
	}
	for ( x = 0; x < 12; x++ ) {
		glitchesLV2.push( new Glitch( random( windowWidth/2, width - 20 ), random( 20, windowHeight/2 ), 0, 0, 10, 0 ) );
	}
	for ( j = 0; j < 14; j++ ) {
		glitchesLV3.push( new Glitch( random( windowWidth/2, width - 20 ), random( windowHeight/2+10, windowHeight ), 0, 0, 10, 0 ) );
	}
	for ( var f = 0; f < 14; f++ ) {
		glitchesLV4.push( new Glitch( random( 20, windowWidth/2 - 20 ), random( windowHeight/2+10, windowHeight ), 0, 0, 10, 0 ) );
	}
}
